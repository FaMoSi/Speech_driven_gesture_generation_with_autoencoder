...
def home_out(path):
    return pjoin('/homes/sfaggi/Desktop/Thesis/', path)
...
flags.DEFINE_integer('layer1_width', 30, 'Number of units in each hidden layer ')
flags.DEFINE_integer('layer2_width', 20, 'Number of units in each hidden layer ')
flags.DEFINE_integer('layer3_width', 30, 'Number of units in each hidden layer ')
